                    ...
                    try {
                        ...
                        if (CollectionUtils.isNotEmpty(jobLogIdList)) {
                            for (Integer jobLogId : jobLogIdList) {
                                ...
                                if (Task.SUCCESS.getCode() == log.getTriggerCode() && log.getHandleCode() == 0) {
                                    JobFailMonitorHelper.monitor(jobLogId);
                                    logger.info(">>>>>>>>>>> job monitor, job running, JobLogId:{}", jobLogId);
                                } else if (Task.SUCCESS.getCode() == log.getHandleCode()) {
                                    // job success, pass
                                    logger.info(">>>>>>>>>>> job monitor, job success, JobLogId:{}", jobLogId);
                                } else if (Task.FAIL.getCode() == log.getTriggerCode()
                                        || Task.FAIL.getCode() == log.getHandleCode()
                                        || Task.FAIL_RETRY.getCode() == log.getHandleCode()) {
                                    // job fail,
                                    failAlarm(log);
